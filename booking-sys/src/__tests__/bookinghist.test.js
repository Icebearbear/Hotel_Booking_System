...
// it("test booking history components shows up", async () => {
...
// const rowValues = getAllByTestId("hotelname").map(
//   (row) => row.textContent
// );

// expect(rowValues).toEqual([
//   bookingData[0][1].hotelName,
//   bookingData[1][1].hotelName,
// ]);
