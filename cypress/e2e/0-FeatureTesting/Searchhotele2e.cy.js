  ...
  for (let i = 0; i < 10; i++) {
    list.push(
      fuzzur.mutate("Rome, Italy", {
        string: {
          sampleSet:
            "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", // The set of chars from which the mutated strings are built, can be overriden with custom sets
