describe("User looking at the hotel page", () => {
  ...
  it("views ViewHotel page", () => {
    cy.get("h2.card-title").should("contain", "Grand Copthorne Waterfront"); // ensure api load data
  ...
  it("clicks on buttons", () => {
    ...
    cy.contains("View rooms").scrollIntoView().click();
    cy.contains("Book your room").scrollIntoView().should("be.visible");
  });
